...
var UserAgent = /** @class */ (function () {
    ...
    UserAgent.getRandomUserAgent = function () {
        var rndVersion = this.androidVersions[~~(Math.random() * this.androidVersions.length)];
        var rndDevice = this.androidDevices[~~(Math.random() * this.androidDevices.length)];
        var rndChromeVersion = this.chromeVersions[~~(Math.random() * this.chromeVersions.length)];
